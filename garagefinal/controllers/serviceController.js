...
exports.addService = async (req, res) => {
  try {
    ...
    res.redirect('/services'); // Rediriger vers la liste des services / Redirect to list of services
  } catch (error) {
...
exports.updateService = async (req, res) => {
  try {
    ...
    // Utilisez la méthode update avec les nouvelles données / Use the update method with new data
